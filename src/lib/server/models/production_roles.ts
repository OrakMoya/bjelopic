...
export type production_rolesCreationAttributes = Optional<
	production_rolesAttributes,
	production_rolesOptionalAttributes
>;

export class production_roles
	extends Model<production_rolesAttributes, production_rolesCreationAttributes>
	implements production_rolesAttributes
{
	id!: number;
	production_role!: string;
