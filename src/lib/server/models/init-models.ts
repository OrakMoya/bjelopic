...
import type { production_rolesAttributes, production_rolesCreationAttributes } from "./production_roles";
...
import type { work_employees_participatedAttributes, work_employees_participatedCreationAttributes } from "./work_employees_participated";
...
export function initModels(sequelize: Sequelize) {
  ...
  employees.hasMany(work_employees_participated, { as: "work_employees_participateds", foreignKey: "employee_id"});
  ...
  work_employees_participated.belongsTo(production_roles, { as: "production_role", foreignKey: "production_role_id"});
  production_roles.hasMany(work_employees_participated, { as: "work_employees_participateds", foreignKey: "production_role_id"});
  ...
  work_videos.hasMany(work_employees_participated, { as: "work_employees_participateds", foreignKey: "work_id"});
