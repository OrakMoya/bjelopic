...
export type work_employees_participatedId =
	work_employees_participated[work_employees_participatedPk];
export type work_employees_participatedCreationAttributes = work_employees_participatedAttributes;

export class work_employees_participated
	extends Model<
		work_employees_participatedAttributes,
		work_employees_participatedCreationAttributes
	>
	implements work_employees_participatedAttributes
{
	id!: number;
	employee_id!: number;
	work_id!: number;
			...
			},
			{
				...
				indexes: [
					...
					},
					{
						...
						unique: true,
						using: 'BTREE',
						fields: [{ name: 'employee_id' }, { name: 'work_id' }, { name: 'production_role_id' }]
					},
					{
						name: 'fk_work_id_idx',
						using: 'BTREE',
					...
					},
					{
						...
						using: 'BTREE',
						fields: [{ name: 'production_role_id' }]
					}
				]
			}
		);
