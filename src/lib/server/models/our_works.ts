...
export type our_worksOptionalAttributes = 'id' | 'title' | 'subject' | 'category';
export type our_worksCreationAttributes = Optional<
	our_worksAttributes,
	our_worksOptionalAttributes
>;

export class our_works
	extends Model<our_worksAttributes, our_worksCreationAttributes>
	implements our_worksAttributes
{
	id!: number;
	title?: string;
	subject?: string;
