...
export type work_rolesCreationAttributes = Optional<work_rolesAttributes, work_rolesOptionalAttributes>;

export class work_roles extends Model<work_rolesAttributes, work_rolesCreationAttributes> implements work_rolesAttributes {
  id!: number;
  work_id!: number;
  role_id!: number;
